...
namespace MVCPOS.DataLayer
{
    public class InvoiceRepository
    {
        ...
        public List<InvoiceListModel> GetInvoiceList(string startdate, string enddate)
        {
        ...
        {
            string query = "select tblSLInv.lngNumberID, tblSLInv.dtmDate , tblSLInv.memInvMemo, tblCust.strCompanyName, tblCust.strEmail, tblCust.strBillToAddress1 from tblSLInv inner join tblCust on tblSLInv.lngClientID = tblCust.lngCustID where lngNumberID='"+id+"' ";
            dal.Db = "Local";
            return GetSingleInvoiceData(query);
        }
        ...
        private InvoiceModel ReadGetInvoiceForTaxData(IDataRecord record)
        {
