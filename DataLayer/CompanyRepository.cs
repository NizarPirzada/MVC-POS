...
namespace MVCPOS.DataLayer
{
    public class CompanyRepository
    {
        ...
        {
            CompanyModel companyObject = new CompanyModel();
            ...
            using (SqlConnection connection = dal.Connect())
            {
                ...
                while (reader.Read())
                {
                    companyObject.StrCompanyName = reader["strCompanyName"].ToString();
                    companyObject.StrCompanyAddress = reader["strCompanyAddress"].ToString();
                    companyObject.StrCompanyEmail = reader["strCompanyEmail"].ToString();
                    companyObject.StrCompanyPhone = reader["strCompanyPhone"].ToString();
                    companyObject.StrInvoiceFooter = reader["strInvoiceFooter"].ToString();
                }
